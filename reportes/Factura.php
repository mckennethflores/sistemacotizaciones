...
$this->Cell(31,5, utf8_decode('-'),1,0, 'L', false);
...
$this->Ln(5);
$this->SetFont('arial','',9);
$this->Cell(35,5,'SOLICITADO POR:',1,0,'C', false);
$this->Cell(65,5,$contacto, 1, 0, 'L', false);
$this->Cell(43,5, utf8_decode('TIEMPO DE ENTREGA:'),1,0, 'C', false);
$this->Cell(45,5, utf8_decode('12 DÍAS'),1,0, 'C', false);
...
function addCadreTVAs($monto,$bcpsoles,$bcpdolares,$cuentadetracciones)
{
	...
	$this->MultiCell(130,4, $monto);
		...
		$this->MultiCell(100,4, "FR SYSTEM S.A.C.");
		$this->SetFont( "Arial", "", 8);
		$this->SetXY( $r1+0, $y1+18);
		$this->MultiCell(100,4, utf8_decode( "N° CTA CTE BCP SOLES: $bcpsoles"));
		$this->SetFont( "Arial", "", 8);
		...
		$this->MultiCell(100,4, utf8_decode("OPERACIÓN SUJETA - SISTEMA PAGO DE OBLIGACIONES"));
		$this->SetFont( "Arial", "", 7);
		$this->SetXY( $r1+63, $y1+18);
		$this->MultiCell(100,4, utf8_decode( "TRIBUTARIAS CON EL GOBIERNO CENTRAL"));
		$this->SetFont( "Arial", "", 7);
		$this->SetXY( $r1+63, $y1+22);
		$this->MultiCell(100,4, utf8_decode( "BANCO DE LA NACIÓN CTA CTE N° $cuentadetracciones"));
		/* $this->SetFont( "Arial", "", 8);
