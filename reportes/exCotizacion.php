...
$pdf->addSociete(utf8_decode(NOMBRE_EMPRESA),
                  utf8_decode(ADDRESS)."\n".
                  utf8_decode("TELEF:: ").CELULAR1."\n" .
                  "EMAIL : ".$email,$logo,$ext_logo);
$pdf->fact_dev(utf8_decode("COTIZACIÓN"), "000"."$regc->serie_comprobante-$regc->num_comprobante", RUC);
$pdf->temporaire( "" );

/*  */
$direccion_cliente = substr($regc->direccion, 0, 94);
//Enviamos los datos del cliente al método addClientAdresse de la clase Factura
$pdf->addClientAdresse(utf8_decode(htmlspecialchars_decode($regc->cliente)),utf8_decode($direccion_cliente),$regc->num_documento,$regc->email,$regc->telefono,formatDateMysql($regc->fecha),$TIPO_MONEDA,$contacto);
...
$pdf->addCadreEurosFrancs("IGV"." $regc->igv %");
